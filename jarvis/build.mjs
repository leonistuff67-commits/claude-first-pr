...
const MODULES = ['memory.js', 'history.js', 'apikey.js', 'connectors.js', 'apps.js', 'tools.js', 'brain.js', 'offline.js', 'clap.js', 'recognizer.js', 'voice.js', 'orb.js', 'wave.js', 'mind.js', 'providers.js', 'gmail.js', 'localbrain.js', 'app.js'];
